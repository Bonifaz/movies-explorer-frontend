                        ...
                        <form className="register__form">
                            <div className="register__inputs">
                                <div className={`register__name ${this.props.statusForm ? "register__name-hidden" : ""}`}>
                                    ...
                                    <input required className="register__name-input register__input" type="text" id="name" name="name" placeholder="Виталий"/>
                                    <label className="register__name-input-label" for="name"></label>
                                </div>
                                <div className="register__email">
                                    <p className="register__input-label-text">E-mail</p>
                                    <input required className="register__email-input register__input" type="email" id="email" name="email" placeholder="pochta@yandex.ru"/>
                                    <label className="register__email-input-label" for="email"></label>
                                </div>
                                <div className="register__password">
                                    <p className="register__input-label-text">Пароль</p>
                                    <input required className="register__password-input register__input" type="password" id="password" name="password" placeholder="&#149 &#149 &#149 &#149 &#149 &#149 &#149 &#149 &#149"/>
